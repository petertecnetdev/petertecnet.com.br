(() => {
  ...
  button.innerHTML = `<span class="pt-install-icon" aria-hidden="true"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 3v12"/><path d="m7 10 5 5 5-5"/><path d="M5 21h14"/></svg></span><span class="pt-install-copy"><strong>Instale ${appName}</strong><span>Acesso rápido, tela cheia e ícone no seu celular.</span></span><span class="pt-install-cta">Instalar aplicativo</span>`;
