...
check('legacy canonical CSS stays before V2 override', navigationImport > responsiveImport && experienceImport > navigationImport)
check('V2 experience is the final Admin CSS layer', experienceImport >= 0)
