...
function Header() {
  ...
  return <header className="mkt-header hub-header">
    <a className="mkt-brand" href="/" onClick={close} aria-label="Peter Tecnet — início">
      <span className="mkt-brand-mark"><img src={PETER_BRAND_LOGO} alt="" /></span>
...
function PlatformCard({ application, index }) {
  ...
  return <article className="mkt-platform-card" data-reveal data-tilt>
    ...
    <a className="mkt-platform-logo" href={applicationHref(application)}><img src={resolveAssetUrl(application.logo) || PETER_BRAND_LOGO} alt={`Logo ${application.name}`} loading="lazy" /></a>
...
function NotFound({ contact }) {
  return <Chrome contact={contact}><main className="mkt-page-state"><img src={PETER_BRAND_LOGO} alt="" /><h1>Página não encontrada.</h1><p>Volte para a Peter Tecnet e encontre produtos, serviços e plataformas.</p><a className="mkt-btn is-primary" href="/">Ir para o início</a></main></Chrome>
}
...
class MarketingRuntimeBoundary extends Component {
  ...
  render() {
    ...
    return <main className="mkt-page-state">
      <img src={PETER_BRAND_LOGO} alt="Peter Tecnet" />
