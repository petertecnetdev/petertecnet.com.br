  ...
  return <div className="cc-stack">
    ...
    {section === 'overview' && <>
      <div className="cc-kpis">
        ...
        <Kpi title="Eventos críticos 24h" value={overview?.security?.critical_events_24h || 0} sub={`${overview?.security?.errors_24h || 0} erros · veja Segurança`} danger={overview?.security?.critical_events_24h > 0}/>
      </div>
    ...
    {section === 'security' && <CriticalEventsPanel security={security}/>} 
