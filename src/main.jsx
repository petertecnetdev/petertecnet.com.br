...
import AdminDatabaseExportLauncher from './AdminDatabaseExportLauncher.jsx'
...
createRoot(document.getElementById('root')).render(
  <StrictMode>
    {path === '/support' ? <SupportAdminApp /> : <><App /><AdminSupportLauncher /><AdminDatabaseExportLauncher /></>}
    <AdminSessionGuard />
    <PwaInstallButton />
  </StrictMode>,
)